<template>
  ...
  >
    <div class="el-submenu__title" ref="submenu-title" :style="paddingStyle">
      ...
      <i class="el-submenu__icon-arrow material-icons" v-if="rootMenu.mode === 'horizontal'">arrow_drop_down</i>
      <i class="el-submenu__icon-arrow material-icons" v-else>expand_more</i>
    </div>
